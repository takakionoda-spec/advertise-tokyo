...
export const siteConfig = {
  ...
  layout: {
    ...
    directory: {
      ...
      pageSize: 24,
      /** TRUE — never show a generic Unsplash stock photo as an article cover.
       *  When the RSS source provides a real image, use it; otherwise fall back
       *  to the editorial tone tile (a flat category-tinted panel with the
       *  article's first letter). This kills the worst editorial failure mode:
       *  a random Unsplash photo that has nothing to do with the article topic,
       *  which mis-signals what the story is about. The tone tile reads as an
       *  intentional editorial choice; a mismatched stock photo reads as
       *  carelessness. */
